...
# create buttons
btn1 = Button(root, text="Select Image", bg='black', fg='darkblue', font=('ariel 15 bold'), relief=GROOVE, command=selected)
btn1.place(x=100, y=595)
btn2 = Button(root, text="Save", width=12, bg='black', fg='darkblue', font=('ariel 15 bold'), relief=GROOVE, command=save)
btn2.place(x=280, y=595)
btn3 = Button(root, text="Exit", width=12, bg='black', fg='darkblue', font=('ariel 15 bold'), relief=GROOVE, command=root.destroy)
